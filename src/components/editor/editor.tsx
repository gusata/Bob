...
import {RxFontBold, RxFontItalic, RxStrikethrough, RxCode, RxCodesandboxLogo} from 'react-icons/rx'
    ...
    <>
        ...
        editor={editor} />
          ...
          shouldShow={({state}) => {
            ...
            <button className='flex items-center gap-1 p-1 rounded min-w-[280px] hover:bg-slate-300'
            ...
            onClick={() => editor.chain().focus().toggleCodeBlock().run()}>
              <img src="http://www.notion.so/images/blocks/code.a8b201f4.png" 
              alt="text"
              className='w-12 border border-zinc-300 rounded' />
        ...
        { editor && (
          <BubbleMenu className='bg-slate-100 border-2 shadow-black/20 shadow-lg rounded-2xl flex flex-1 divide-x divide-slate-300  overflow-hidden' editor={editor}>
              <BubbleButton
